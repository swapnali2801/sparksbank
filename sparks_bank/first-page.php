...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #96BAFF;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="https://image.flaticon.com/icons/png/128/901/901388.png" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. MADE BY <b>SWAPNALI PATIL</b> <br> </p>
      </footer>
